...
begin
  Result := Concat(IPByteEdit[0].Text, '.', IPByteEdit[1].Text, '.', IPByteEdit[2].Text, '.', IPByteEdit[3].Text);
end;
...
begin
  Result := (StrToInt(IPByteEdit[0].Text) shl 24) or (StrToInt(IPByteEdit[1].Text) shl 16) or (StrToInt(IPByteEdit[2].Text) shl 8) or StrToInt(IPByteEdit[3].Text);
end;
...
procedure Register;
begin
  RegisterComponents('PxVCL', [TIPEdit]);
end;
