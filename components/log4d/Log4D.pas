...
{ Loggers ---------------------------------------------------------------------}
  ...
  public
    ...
    procedure Debug(const Message: string; const Err: Exception = nil);
      overload; virtual;
    procedure Debug(const Message: string; Params: array of const; const Err: Exception = nil);
      overload; virtual;
    ...
    procedure Error(const Message: string; const Err: Exception = nil);
      overload; virtual;
    procedure Error(const Message: string; Params: array of const; const Err: Exception = nil);
      overload; virtual;
    ...
    procedure Fatal(const Message: string; const Err: Exception = nil);
      overload; virtual;
    procedure Fatal(const Message: string; Params: array of const; const Err: Exception = nil);
      overload; virtual;
    ...
    procedure Info(const Message: string; const Err: Exception = nil);
      overload; virtual;
    procedure Info(const Message: string; Params: array of const; const Err: Exception = nil);
      overload; virtual;
    ...
    procedure Log(const LogLevel: TLogLevel; const Message: string; Params: array of const;
      const Err: Exception = nil); overload;
    ...
    procedure Warn(const Message: string; const Err: Exception = nil);
      overload; virtual;
    procedure Warn(const Message: string; Params: array of const; const Err: Exception = nil);
      overload; virtual;
...
procedure TLogLogger.Debug(const Message: string; Params: array of const; const Err: Exception);
begin
  Log(Log4D.Debug, Format(Message, Params), Err);
end;
...
procedure TLogLogger.Error(const Message: string; Params: array of const; const Err: Exception);
begin
  Log(Log4D.Error, Format(Message, Params), Err);
end;
...
procedure TLogLogger.Fatal(const Message: string; Params: array of const; const Err: Exception);
begin
  Log(Log4D.Fatal, Format(Message, Params), Err);
end;
...
procedure TLogLogger.Info(const Message: string; Params: array of const; const Err: Exception);
begin
  Log(Log4D.Info, Format(Message, Params), Err);
end;
...
procedure TLogLogger.Log(const LogLevel: TLogLevel; const Message: string; Params: array of const;
  const Err: Exception);
begin
  if Hierarchy.IsDisabled(LogLevel.Level) then
    Exit;
  if IsEnabledFor(LogLevel) then
    DoLog(LogLevel, Format(Message, Params), Err);
end;
...
procedure TLogLogger.Warn(const Message: string; Params: array of const; const Err: Exception);
begin
  Log(Log4D.Warn, Format(Message, Params), Err);
end;
