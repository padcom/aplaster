...
const
  CMD_DIGITAL_INPTUT_BASE       = CMD_BASE + 30;
  CMD_DIGITAL_INPTUT_OPEN       = CMD_DIGITAL_INPTUT_BASE + 0;
  CMD_DIGITAL_INPTUT_CLOSE      = CMD_DIGITAL_INPTUT_BASE + 1;
  CMD_DIGITAL_INPTUT_GET_STATUS = CMD_DIGITAL_INPTUT_BASE + 2;
  CMD_DIGITAL_INPTUT_STATUS     = CMD_DIGITAL_INPTUT_BASE + 3;
